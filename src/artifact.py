...
.ph2{{padding:8px 12px;font-size:10px;text-transform:uppercase;letter-spacing:.07em;color:var(--tm);border-bottom:1px solid var(--bd);font-weight:500;background:var(--sf2);position:sticky;top:38px;z-index:5}}
...
.wa{{font-family:var(--mono);font-size:10px;color:var(--ts)}}
...
.tt2 th{{font-size:10px;text-transform:uppercase;letter-spacing:.06em;color:var(--tm);padding:5px 8px;text-align:right;font-weight:500;background:var(--sf2);border-bottom:1px solid var(--bd);cursor:pointer;white-space:nowrap;position:sticky;top:38px}}
